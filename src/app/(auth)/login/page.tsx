      ...
      <div className="bg-white rounded-3xl shadow-sm w-full max-w-md p-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <button
            ...
            className="w-full h-12 bg-[#A0522D] hover:bg-[#8B4513] text-white font-semibold rounded-xl transition-colors text-sm disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
